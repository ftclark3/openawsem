...
def run(args):
    ...
    oa = OpenMMAWSEMSystem(input_pdb_filename, k_awsem=1.0, chains=chain, xml_filename=openawsem.xml, 
                           seqFromPdb=seq, includeLigands=args.includeLigands, massless_surface=True)  # k_awsem is an overall scaling factor that will affect the relevant temperature scales
