...
def set_up_forces(oa, protein, force_name=None):
    ...
    all_forces = {
        ...
        "Pap1": lambda: openawsem.functionTerms.hydrogenBondTerms.pap_term_1(oa,ssweight=data_path/f'{protein}-ssweight'),
        "Pap2": lambda: openawsem.functionTerms.hydrogenBondTerms.pap_term_2(oa,ssweight=data_path/f'{protein}-ssweight'),
