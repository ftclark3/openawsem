...
"""
compares OpenAWSEM implementation of alpha helical hbond energy from LAMMPS AWSEM-MD commit cea754f 
...
def set_up_forces(oa, protein, force_name=None):
    ...
    all_forces = {
        ...
        "Helical": lambda: openawsem.functionTerms.hydrogenBondTerms.density_dependent_helical_term(oa,k_helical=0.5*4.184,forceGroup=29),
...
class TestEnergyTerms:
    def test_energy_term(self, platform, column, analyzed_data):
        ...
        for protein in PROTEINS:
            ...
            assert column in saved_energies.columns, f"Column {column} not found in saved energies for protein {protein} on platform {platform},-----{saved_energies.columns}"
