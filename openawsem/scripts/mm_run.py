...
def run(args):
    ...
    PDBxFile.writeFile(oa.pdb.topology,oa.pdb.positions,file='reindexed.cif',keepIds=True)
    PDBFile.writeFile(oa.pdb.topology,oa.pdb.positions,file='reindexed.pdb')
